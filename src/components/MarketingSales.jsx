...
export default function MarketingSales({ data }) {
  ...
  useGSAP(
    () => {
      const images = gsap.utils.toArray(".sales-image");
      images.forEach((img, i) => {
        gsap.fromTo(
          ...
          },
          {
            ...
            onComplete: () => {
              // Add a subtle yoyo floating effect after entrance
              gsap.to(img, {
                y: 5,
                duration: 1.8,
                repeat: -1,
  ...
  return (
    <div
      ref={containerRef}
      className="bg-linear-to-b from-[#FDECFF] via-[#fef0ff] to-[#ffffff] rounded-[40px] p-12 flex flex-col lg:flex-row gap-12 w-full max-w-[1240px] mx-auto overflow-hidden"
    >
          ...
          <div ref={imageContainerRef} className="w-full h-fit flex items-center justify-center">
            <div className="relative w-[300px] h-[300px] flex items-center justify-center">
              ...
              <div className="absolute top-5 -left-10 w-[400px]">
                <img
                  src="https://www.wati.io/wp-content/uploads/2025/08/wati-for-sales-animate-text1.webp"
                  alt=""
                  className="sales-image opacity-0"
                />
              </div>
              <div className="absolute top-20 left-0 w-[400px]">
                <img
                  src="https://www.wati.io/wp-content/uploads/2025/08/wati-for-sales-animate-text2.webp"
                  alt=""
                  className="sales-image opacity-0"
                />
              </div>
